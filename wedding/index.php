...
<div id="wrap">
	<div id="shadow">
		...
		<div id="main-body">
			...
			<p>Our wedding is scheduled to take place on December 30, 2006. The wedding will be held at the historic <a href="http://www.morsechurch.org/">Morse Church</a> in Overland Park, Kansas.  The reception will be held at the <a href="http://www.lenexaconferencecenter.com/">Lenexa Conference Center</a> in Lenexa, Kansas.</p>
			<!-- InstanceEndEditable -->
				</div> <!-- end .gutter -->
			</div> <!-- end #content -->
		</div> <!-- end #main-body -->
